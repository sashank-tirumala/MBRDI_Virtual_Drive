...
class PropHandler():
    def __init__(self):
        self.paths= {'Sg274Hoechstgeschw30_03.flt' : './sketchup_models/200m_blue_sign.dae',
        'Sg451.flt' : './sketchup_models/exit_sign.dae',
        'Sg332Ausfahrttafel.flt' : './sketchup_models/bridge_ahead.dae',
    ...
    def place(self,origin,angle,scale,id):
        ...
        bpy.data.objects[id].location = [origin.x,origin.y,origin.z]
        bpy.data.objects[id].rotation_euler[2] = angle
        bpy.data.objects[id].scale = [s/scale for s in bpy.data.objects[id].scale]
